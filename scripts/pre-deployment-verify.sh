...
check_environment_files() {
    ...
    print_check "Checking .env.your-aws-profile file..."
    if [ -f "$PROJECT_ROOT/.env.your-aws-profile" ]; then
        print_pass ".env.your-aws-profile file exists"
        ...
        for var in "${CRITICAL_VARS[@]}"; do
            if grep -q "^$var=" "$PROJECT_ROOT/.env.your-aws-profile"; then
        ...
        print_fail ".env.your-aws-profile file not found"
