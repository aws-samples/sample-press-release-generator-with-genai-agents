...
AWS_PROFILE=$PROFILE terraform import aws_vpc.main vpc-096b706df30288c3b || echo "  Already imported or failed"

echo "Step 2: Importing Subnets..."
AWS_PROFILE=$PROFILE terraform import 'aws_subnet.public[0]' subnet-01f57b883b8747d68 || echo "  Already imported or failed"
AWS_PROFILE=$PROFILE terraform import 'aws_subnet.public[1]' subnet-0740f19978d198576 || echo "  Already imported or failed"
AWS_PROFILE=$PROFILE terraform import 'aws_subnet.private[0]' subnet-0a9943b63ac2c2faf || echo "  Already imported or failed"
AWS_PROFILE=$PROFILE terraform import 'aws_subnet.private[1]' subnet-0bcf9e39f3549bf89 || echo "  Already imported or failed"
...
AWS_PROFILE=$PROFILE terraform import 'aws_cognito_user_pool.main[0]' us-west-2_q22RPJlnq || echo "  Already imported or failed"
AWS_PROFILE=$PROFILE terraform import 'aws_cognito_user_pool_domain.main[0]' press-release-generator-prod-g8a30ood || echo "  Already imported or failed"
